...
function PACKS.oneiric()
  ...
  register("place",  rev(Synth.tone{ wave = "sine", freq = 88, dur = 0.16, a = 0.012, slide = -40, lp = 0.60, detune = 0.005, sub = 0.40, vol = 0.20, r = 0.10 }, 0.40, 0.30), { jitter = 0.05 }) -- THUNK de pierre feutré : masse organique qui se pose sur la dalle (grave, poids/sub, étouffé, swell doux, discret)
  register("unlock", rev(Synth.tone{ wave = "sine", freq = 120, dur = 0.26, a = 0.018, slide = 90, lp = 0.58, detune = 0.006, harm = 0.12, sub = 0.35, vol = 0.18, r = 0.13 }, 0.55, 0.36), { jitter = 0.03 }) -- DALLE qui s'OUVRE : grave + poids (sub), slide ASCENDANT = révélation/ouverture, léger harm = lumière qui filtre, swell doux ; queue plus longue que `place` mais sous le climax success/thud (petit jalon)
