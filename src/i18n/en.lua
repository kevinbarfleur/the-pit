...
return {
  ...
  ["unit.stormcaller.passive_desc"] = "Stacks shock: the target takes +7% damage per shock stack. Where it looks, the foe is marked: +12% damage for ~1.5s.",
  ...
  ["unit.carrion_pecker.passive_desc"] = "Fast strikes swell rot quickly, but it caps low (6 dmg/s). The scavenger gorges on what it kills: +4 HP on every kill.",
  ["unit.maggot_king.name"] = "THE STRUNG TYRANT",
  ["unit.maggot_king.passive_name"] = "Teeming",
  ["unit.maggot_king.passive_desc"] = "Slow to start, but rot swells high (up to 12 dmg/s) over a long fight. The tyrant commands: adjacent attackers deal +20% damage.",
  ...
  ["unit.skull_colossus.passive_desc"] = "A titanic skull: draws fire (taunt) and burns for 4 dmg/s. Every soul it crushes rekindles its embers: +8 HP on each kill.",
