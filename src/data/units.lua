...
local U = {
  marauder = {
    id = "marauder", type = "flesh", family = "crustace", arch = "crab", rank = 1, cost = 1, hp = 60, dmg = 9, cd = 60, aggro = 15, -- MARAUDER / Brutality (bruiser)
  ...
  templar = {
    id = "templar", type = "order", family = "seraphin", arch = "seraph", rank = 3, cost = 3, hp = 95, dmg = 12, cd = 82, aggro = 40, -- TEMPLAR / Bulwark (tank)
  ...
  skeleton = {
    id = "skeleton", type = "bone", family = "mortvivant", arch = "skeleton", rank = 1, cost = 1, hp = 40, dmg = 6, cd = 44, -- SKELETON / Broken Bones
  ...
  bandit = {
    id = "bandit", type = "flesh", family = "crustace", arch = "mantisshrimp", rank = 1, cost = 1, hp = 46, dmg = 7, cd = 36, -- BANDIT / Nimble
  ...
  demon = {
    ...
    id = "demon", type = "abyss", family = "abyssal", arch = "anglerfish", rank = 1, cost = 1, hp = 64, dmg = 9, cd = 56, aggro = 25, -- DEMON / Leech (bruiser-leurre)
  ...
  plague_doctor = { -- CONTRE-DoT : régénération + PURGE BORNÉE (incline le matchup poison, n'efface pas)
    id = "plague_doctor", bodyplan = "robe", rank = 3, type = "order", family = "essaim", arch = "swarm", cost = 3, hp = 80, dmg = 6, cd = 66, aggro = 40,
  ...
  leech_thorn = { -- bleed bas + ÉPINES (punit qui le frappe) : DEUX effets via ops existants
    id = "leech_thorn", bodyplan = "arachnid", rank = 3, type = "bone", family = "wendigo", arch = "stag", cost = 3, hp = 46, dmg = 4, cd = 50,
    effects = {
  ...
  carrion_pecker = { -- rot rapide (cap bas) + SOIN-SUR-KILL : le charognard se repaît du cadavre qu'il a fait
    id = "carrion_pecker", bodyplan = "swarm", rank = 1, type = "flesh", family = "colosse", arch = "cyclops", cost = 1, hp = 38, dmg = 4, cd = 38,
  ...
  maggot_king = { -- rot (cap HAUT) + AMPLI FORGE : empower-aura (le pantin-tyran ORDONNE aux voisins-frappeurs)
    id = "maggot_king", bodyplan = "swarm", rank = 3, type = "bone", family = "pendu", arch = "marionette", cost = 3, hp = 70, dmg = 5, cd = 64,
  ...
  bellows_priest = { -- anti-décroissance (brûlure tenace) + AMPLI HÂTE : le soufflet attise (les voisins frappent + vite)
    id = "bellows_priest", bodyplan = "robe", rank = 3, type = "abyss", family = "culte", arch = "cultist", cost = 3, hp = 44, dmg = 5, cd = 58,
  ...
  bloodletter = { -- le saignement ÉCLATE (×2) quand la cible attaque (payoff conditionnel)
    id = "bloodletter", bodyplan = "humanoid", rank = 4, type = "flesh", family = "echassier", arch = "strider", cost = 4, hp = 48, dmg = 5, cd = 48,
  ...
  plague_bearer = { -- CONTAGION : le poison se propage en stack plus faible aux voisins de la cible
    id = "plague_bearer", bodyplan = "cephalopod", rank = 4, type = "arcane", family = "cocon", arch = "chrysalis", cost = 4, hp = 40, dmg = 5, cd = 58,
  ...
  acid_maw = { -- le venin RONGE le bouclier (−30 % par pose : dissout l'armure)
    id = "acid_maw", bodyplan = "cephalopod", rank = 3, type = "abyss", family = "cephalo", arch = "squid", cost = 3, hp = 46, dmg = 5, cd = 56,
  ...
  patient_worm = { -- la pourriture enfle même SANS frapper (ramp passif tant qu'active)
    id = "patient_worm", bodyplan = "serpent", rank = 4, type = "bone", family = "pendu", arch = "hanged", cost = 4, hp = 58, dmg = 4, cd = 52,
  ...
  hollow_gut = { -- l'amputation des PV max NOURRIT le porteur (vol de plafond de vie)
    id = "hollow_gut", bodyplan = "blob", rank = 4, type = "abyss", family = "gelatine", arch = "blobmonster", cost = 4, hp = 50, dmg = 5, cd = 58,
  ...
  blight_spreader = { -- à la mort d'une cible pourrie, la pourriture prend ses voisins (proximité champ)
    id = "blight_spreader", bodyplan = "swarm", rank = 4, type = "bone", family = "pendu", arch = "marionette", cost = 4, hp = 52, dmg = 5, cd = 56,
    effects = {
  ...
  ash_maw = { -- TRANSFORM : tant qu'il vit, les feux de l'ÉQUIPE ne décroissent plus (les braises éternelles)
    id = "ash_maw", bodyplan = "chimera:cephalopod:quadruped", rank = 5, type = "abyss", family = "culte", arch = "possessed", cost = 5, hp = 70, dmg = 6, cd = 60,
    effects = {
  ...
  plague_pyre = { -- CROISÉ feu->poison : quand sa brûlure saute à la mort, elle SÈME aussi du venin
    id = "plague_pyre", bodyplan = "chimera:humanoid:tentacles", rank = 5, type = "abyss", family = "culte", arch = "possessed", cost = 5, hp = 56, dmg = 6, cd = 56,
    effects = {
      { trigger = "on_hit", op = "burn", params = { dps = 5, dur = 150 } },
  ...
  slow_bleed = { -- TRANSFORM : au début du combat, RALENTIT toute l'équipe ennemie (la mort par mille coupures)
    id = "slow_bleed", bodyplan = "chimera:humanoid:quadruped", rank = 5, type = "bone", family = "wendigo", arch = "stag", cost = 5, hp = 64, dmg = 5, cd = 54,
    effects = {
  ...
  marrow_drinker = { -- CROISÉ saignement->pourriture : sur une cible DÉJÀ saignante, convertit le bleed en rot
    id = "marrow_drinker", bodyplan = "cephalopod", rank = 5, type = "abyss", family = "ombre", arch = "voidtyrant", cost = 5, hp = 54, dmg = 6, cd = 52,
  ...
  festering = { -- TRANSFORM : le poison de l'ÉQUIPE ignore son cap de stacks ET dure plus longtemps
    id = "festering", bodyplan = "chimera:cephalopod:tentacles", rank = 5, type = "arcane", family = "cauchemar", arch = "fleshcrawler", cost = 5, hp = 50, dmg = 6, cd = 60,
    effects = {
  ...
  venom_censer = { -- CROISÉ poison->feu : à N stacks de poison, la cible DÉTONE en flammes (accumule puis détonne)
    id = "venom_censer", bodyplan = "chimera:humanoid:tentacles", rank = 5, type = "arcane", family = "cocon", arch = "embersac", cost = 5, hp = 48, dmg = 6, cd = 58,
  ...
  pit_maw = { -- TRANSFORM (signature thème) : au début du combat, la pourriture rampe sur TOUTE l'équipe ennemie
    id = "pit_maw", bodyplan = "chimera:cephalopod:quadruped", rank = 5, type = "bone", family = "larve", arch = "devourer", cost = 5, hp = 76, dmg = 5, cd = 64,
    effects = {
      { trigger = "on_hit", op = "rot", params = { base = 1, growth = 1, dur = 240, capDps = 10, maxHpFrac = 0.15 } },
  ...
  wither_bloom = { -- CROISÉ rot->slow+malus : pourriture qui RALENTIT et AFFAIBLIT aussi (l'usure totale, anti-stat)
    id = "wither_bloom", bodyplan = "chimera:cephalopod:tentacles", rank = 5, type = "abyss", family = "ombre", arch = "voidmaw", cost = 5, hp = 58, dmg = 5, cd = 60,
    effects = {
  ...
  gravewarden = { -- TANK / TAUNT
    id = "gravewarden", bodyplan = "humanoid", rank = 4, type = "bone", family = "mortvivant", arch = "revenant", cost = 4, hp = 100, dmg = 3, cd = 84, aggro = 40, taunt = true,
  ...
  live_wire = { -- T1 : cadence rapide, petite charge (empile vite) — chaff semeur de choc
    id = "live_wire", bodyplan = "swarm", rank = 1, type = "arcane", family = "oeil", arch = "eyeball", cost = 1, hp = 28, dmg = 3, cd = 30, aggro = 5,
  ...
  static_swarm = { -- T1 : cap élevé, charge régulière, longue durée — choqueur patient (combats longs)
    id = "static_swarm", bodyplan = "swarm", rank = 2, type = "abyss", family = "abyssal", arch = "moray", cost = 2, hp = 44, dmg = 4, cd = 50, aggro = 5,
  ...
  galvanizer = { -- T2 : charge PUIS déclenche sa propre décharge (auto-synergie) — bruiser autonome
    id = "galvanizer", bodyplan = "arachnid", rank = 4, type = "flesh", family = "rongeur", arch = "ratking", cost = 4, hp = 58, dmg = 11, cd = 64, aggro = 15,
    effects = {
  ...
  dynamo_priest = { -- TRANSFER : à la décharge, la moitié des stacks SAUTE sur un voisin (la charge se propage)
    id = "dynamo_priest", bodyplan = "robe", rank = 4, type = "arcane", family = "oeil", arch = "eyecluster", cost = 4, hp = 48, dmg = 5, cd = 58, aggro = 5,
  ...
  arc_warden = { -- CHAIN : la décharge ARQUE vers 2 ennemis proches (60% des dégâts) — nettoyage de ligne
    id = "arc_warden", bodyplan = "arachnid", rank = 4, type = "abyss", family = "abyssal", arch = "deepone", cost = 4, hp = 52, dmg = 6, cd = 60, aggro = 5,
  ...
  storm_anchor = { -- PERSIST : la charge ne se consume pas entièrement (garde la moitié) — pression continue
    id = "storm_anchor", bodyplan = "eye", rank = 3, type = "arcane", family = "cristal", arch = "crystalcluster", cost = 3, hp = 56, dmg = 5, cd = 62, aggro = 15,
  ...
  shieldbearer = { -- tank cheap, petite aura : le porte-bouclier de masse (sort souvent en boutique)
    id = "shieldbearer", bodyplan = "humanoid", rank = 2, type = "order", family = "seraphin", arch = "throne", cost = 2, hp = 72, dmg = 2, cd = 80, aggro = 40,
  ...
  aegis_warden = { -- tank-épines + TAUNT : blinde les voisins ET punit qui le frappe (mur de front complet)
    id = "aegis_warden", bodyplan = "humanoid", rank = 4, type = "bone", family = "mortvivant", arch = "revenant", cost = 4, hp = 96, dmg = 3, cd = 84, aggro = 40, taunt = true,
    effects = {
  ...
  oath_keeper = { -- premium offensif-défensif : grosse aura + dégâts corrects (pilier d'équipe)
    id = "oath_keeper", bodyplan = "humanoid", rank = 4, type = "order", family = "templier", arch = "paladin", cost = 4, hp = 84, dmg = 8, cd = 70, aggro = 15,
  ...
  bulwark_acolyte = { -- support fragile : bouclier modeste mais sur TOUS les voisins (max de couverture)
    id = "bulwark_acolyte", bodyplan = "robe", rank = 3, type = "arcane", family = "golem", arch = "golem", cost = 3, hp = 40, dmg = 5, cd = 60, aggro = 5,
  ...
  ward_weaver = { -- BASE : caster périodique (re-bouclier 20 toutes les 4 s aux voisins)
    id = "ward_weaver", bodyplan = "robe", rank = 4, type = "order", family = "seraphin", arch = "throne", cost = 4, hp = 80, dmg = 4, cd = 64, aggro = 40,
  ...
  barrier_savant = { -- RENFORT : +50% valeur (increased) ET −25% cooldown au caster voisin
    id = "barrier_savant", bodyplan = "robe", rank = 4, type = "order", family = "templier", arch = "crusader", cost = 4, hp = 46, dmg = 4, cd = 60, aggro = 15,
  ...
  mirror_ward = { -- RENFORT : RÉFLEXION (40% de l'absorbé mord l'attaquant) + LARGEUR (rayon 2)
    id = "mirror_ward", bodyplan = "robe", rank = 4, type = "order", family = "seraphin", arch = "seraph", cost = 4, hp = 50, dmg = 5, cd = 58, aggro = 15,
  ...
  surge_warden = { -- RENFORT : SURCHARGE (les boucliers non-consommés s'accumulent, cap 2×) + valeur
    id = "surge_warden", bodyplan = "robe", rank = 4, type = "order", family = "griffon", arch = "hippogriff", cost = 4, hp = 48, dmg = 4, cd = 60, aggro = 15,
  ...
  siege_breaker = { -- COUNTER strip-shield + CLEAVE (SEUL hôte cleave v1) : déchire la ligne en travers (profondeur 1)
    id = "siege_breaker", bodyplan = "deformed", rank = 3, type = "flesh", family = "canide", arch = "wolf", cost = 3, hp = 60, dmg = 8, cd = 52, aggro = 15,
  ...
  bore_worm = { -- ANNÉLIDE / foreur qui digère
    id = "bore_worm", type = "bone", family = "annelide", arch = "graboid", rank = 2, cost = 2, hp = 58, dmg = 5, cd = 58,
  ...
  zeal_inquisitor = { -- INQUISITEUR / feu sacré + AMPLI FORGE (2e accès empower, early rk-2 : le prêtre exhorte)
    id = "zeal_inquisitor", type = "order", family = "inquisiteur", arch = "inquisitor", rank = 2, cost = 2, hp = 64, dmg = 8, cd = 68, aggro = 15,
  ...
  coil_viper = { -- REPTILE / venin de cobra + 2e PLAIE SI ABSENTE (le cobra ouvre une 2e plaie là où la chair est saine)
    id = "coil_viper", type = "flesh", family = "reptile", arch = "cobra", rank = 2, cost = 2, hp = 46, dmg = 7, cd = 48,
  ...
  skull_colossus = { -- CRÂNE COLOSSAL / vestige titanesque + SOIN-SUR-KILL (payoff de combat non-multiplicatif, A11)
    id = "skull_colossus", type = "bone", family = "crane", arch = "skulltitan", rank = 5, cost = 5, hp = 92, dmg = 11, cd = 84, aggro = 40,
  ...
  runestone_golem = { -- GOLEM / pierre runique qui protège (tank-support)
    id = "runestone_golem", type = "arcane", family = "golem", arch = "sentinel", rank = 4, cost = 4, hp = 88, dmg = 10, cd = 80, aggro = 40,
  ...
  footman = { id = "footman", type = "order", family = "automate", arch = "automaton", rank = 1, cost = 1, hp = 46, dmg = 7, cd = 52, aggro = 10, effects = {},
