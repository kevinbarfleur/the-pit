-- feel-lab/lib/sfx.lua
-- DIRECTEUR DE SON — bake une palette de SFX d'UI procéduraux (lib/synth.lua), les joue avec VARIATION DE
...
--
-- 4 PACKS COMPARABLES (mood) :
--   candy     — l'actuel : sinus aigus, clairs, ascendants, musicaux (la réf « trop intense »)
--   grimdark  — DÉFAUT : donjon/pierre, mat, grave, retenu, descendant (sobre, lisible)
--   visceral  — humide/chair : squelch, gargouillis, succion (dégueulasse, body-horror)
--   nightmare — arcane/cauchemar : désaccordé, dissonant, drones, inharmonique (cryptique)
--
